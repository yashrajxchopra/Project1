...
let twoDarray= [ [10,20,30], [40,50,60], [70,80]]
...
console.log(myObj.address.pincodes[0])
const employees = [
...
const newempNames = employees.filter(employees => employees.end - employees.start >= 6 && employees.designation=="IT").map(emp => emp.id)
